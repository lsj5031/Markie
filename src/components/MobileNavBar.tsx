...
export const MobileNavBar: React.FC<MobileNavBarProps> = ({
  ...
  const showPageControls =
    showPagination && activeTab === "preview" && totalPages > 1;
  ...
  return (
    ...
    >
      ...
      {showPageControls && (
        <div
          className="absolute left-1/2 -translate-x-1/2 bottom-[calc(100%+16px)] flex items-center gap-1.5 p-1.5 rounded-full shadow-xl border"
          style={{
            backgroundColor: "var(--studio-surface)",
            borderColor: "var(--studio-border)",
            zIndex: 60,
        ...
        >
          <button
            ...
            style={{
              ...
              height: "36px",
              backgroundColor:
                currentPage === 0 ? "transparent" : "var(--studio-accent)",
          ...
          <button
            ...
            style={{
              ...
              color:
                currentPage === totalPages - 1 ? "var(--studio-text)" : "white",
            }}
